...
public sealed class QuizQuestionSubmissionAuditLogEntityConfiguration : IEntityTypeConfiguration<QuizQuestionSubmissionAuditLogEntity>
{
    public void Configure(EntityTypeBuilder<QuizQuestionSubmissionAuditLogEntity> builder)
    {
        builder.ToTable("QuizQuestionSubmissionAuditLog");
        ...
        builder.HasIndex(log => new { log.QuizQuestionSubmissionId, log.OccurredAt })
