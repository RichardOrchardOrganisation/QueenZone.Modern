...
public sealed class TriviaFactSubmissionAuditLogEntityConfiguration : IEntityTypeConfiguration<TriviaFactSubmissionAuditLogEntity>
{
    public void Configure(EntityTypeBuilder<TriviaFactSubmissionAuditLogEntity> builder)
    {
        builder.ToTable("TriviaFactSubmissionAuditLog");
        ...
        builder.HasIndex(log => new { log.TriviaFactSubmissionId, log.OccurredAt })
