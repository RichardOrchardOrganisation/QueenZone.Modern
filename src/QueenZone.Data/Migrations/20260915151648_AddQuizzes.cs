    ...
    public partial class AddQuizzes : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizAttempts_MemberAccountId_CompletedAt",
                table: "QuizAttempts",
                columns: new[] { "MemberAccountId", "CompletedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_QuizAttempts_QuizId_CompletedAt",
                table: "QuizAttempts",
                columns: new[] { "QuizId", "CompletedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_QuizOptions_QuestionId_DisplayOrder",
                table: "QuizOptions",
