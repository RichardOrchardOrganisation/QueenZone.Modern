...
namespace QueenZone.Data.Migrations
{
    ...
    [Migration("20260923075451_AddMemberDeletionBlobOutbox")]
    partial class AddMemberDeletionBlobOutbox
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QueenZone.Data.Entities.MemberAccount", b =>
                {
                    ...
                    b.Property<DateTime?>("PasswordFailureWindowStartedAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("QueenZone.Data.Entities.MemberDeletionBlobEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("MemberDeletionBlobs", (string)null);
                });
            ...
            modelBuilder.Entity("QueenZone.Data.Entities.MemberExternalLogin", b =>
                {
                    ...
                    b.Property<string>("AppleRefreshTokenProtected")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("QueenZone.Data.Entities.QueenHistoryEventEntity", b =>
                {
                    ...
                    b.Property<int>("EventMonthDay")
                        .ValueGeneratedOnAddOrUpdate()
                        .HasColumnType("int")
                        .HasComputedColumnSql("MONTH([EventDate]) * 100 + DAY([EventDate])", true);
                    ...
                    b.HasIndex("IsPublished", "DatePrecision", "EventMonthDay")
            ...
            modelBuilder.Entity("QueenZone.Data.Entities.QuizQuestionSubmissionAuditLogEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<Guid>("QuizQuestionSubmissionId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("QuizQuestionSubmissionId", "OccurredAt")
                        .IsDescending(false, true)
                        .HasDatabaseName("IX_QuizQuestionSubmissionAuditLog_Submission_OccurredAt");

                    b.ToTable("QuizQuestionSubmissionAuditLog", (string)null);
                });

            modelBuilder.Entity("QueenZone.Data.Entities.QuizQuestionSubmissionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<DateTimeOffset?>("AddedToQuizAt")
                        .HasColumnType("datetimeoffset");

                    b.Property<Guid?>("AddedToQuizId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("QuizQuestionSubmissions", (string)null);
                });

            modelBuilder.Entity("QueenZone.Data.Entities.QuizQuestionSubmissionOptionEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("QuizQuestionSubmissionId", "DisplayOrder")
            ...
            modelBuilder.Entity("QueenZone.Data.Entities.QuizQuestionSubmissionAuditLogEntity", b =>
                {
                    b.HasOne("QueenZone.Data.Entities.QuizQuestionSubmissionEntity", "Submission")
                        .WithMany("AuditLogs")
                        .HasForeignKey("QuizQuestionSubmissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
